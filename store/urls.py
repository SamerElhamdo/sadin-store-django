...
urlpatterns = [
    ...
    path('home/<str:slug>', views.category_list, name='category_list'),
    path('control/list-product/', views.control_list_product, name='control_list_product'),
    path('control/add-category/', views.control_add_category, name='new_category'),
    path('control/edit-category/<category_id>', views.control_edit_category, name='edit_category'),
    path('control/delete-category/<category_id>', views.control_delete_category, name='delete_category'),
    path('control/add-product/', views.control_add_product, name='new_product'),
    path('control/list-category/', views.control_list_category, name='control_list_category'),
